...
# --- BAGIAN INI DI-EDIT UNTUK BYPASS ---
# Kita hapus pengecekan ke server kiryusekei
# Langsung anggap izin diterima
echo -e "\e[32mLOGIKA IZIN DIBYPASS...\e[0m"
echo "IZIN DI TERIMA!! (FULL ACCESS)"
# ---------------------------------------
