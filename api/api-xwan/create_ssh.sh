...
checking_sc() {
    # Logika pengecekan ke server dihapus
    # Langsung dianggap sukses (Lifetime)
...
# Masukkan ID dan Token Bot Anda di sini agar notifikasi masuk ke Anda.
CHATID="" 
KEY=""
# ----------------------------------------
...
# Hanya kirim notifikasi jika KEY dan CHATID diisi
